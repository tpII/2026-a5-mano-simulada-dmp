...
#list(
  [Adquirir las mediciones del acelerómetro, giroscopio y magnetómetro del MPU6050 mediante el ESP32.],
...
#list(
  [Recibir los datos del sensor MPU6050 mediante el protocolo I2C.],
...
Para realizar la investigación se desarrollará un dispositivo capaz de adquirir información relacionada con el movimiento y la orientación de una mano montando el MPU6050 sobre un guante y conectándolo a un ESP32. Los datos obtenidos serán procesados y transmitidos por red hacia una aplicación de software, donde se realizará la reconstrucción y visualización del movimiento de la mano.

El MPU6050 estará conectado al ESP32 mediante el bus de comunicación I²C. El sensor proporcionará tanto la aproximación de la orientación realizada por el DMP como las mediciones del acelerómetro y del giroscopio, que serán utilizadas por el ESP32 para obtener la otra estimación de orientación planteada en el proyecto.
...
== Partes de hardware
El hardware necesario para el desarrollo estará compuesto principalmente por:
...
Además, como se observa en la figura, el fabricante indica el uso de capacitores de desacople en el circuito de alimentación: 0,1 µF para VDD y REGOUT, y 10 nF para VDDIO.
#figure(
...
#list(
  ...
  [Configuración y comunicación con el MPU6050 mediante I²C.],
